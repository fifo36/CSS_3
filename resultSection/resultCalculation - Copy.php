...
function updateGpaToDB($singleFetch, $connection){
    ...
    $queryString = "UPDATE `college_management1`.`full_exam_marks` SET `gpa` = $gpa WHERE (`student_id` = $studentId) and (`exam_id` = $examId);";
        ...
        if($query) {
            // echo "Student id ".$studentId ." gap : ". $gpa;
            // echo '<br>';
            }
...
if(isset($_POST['submit'])){
  ...
  JOIN college_management1.exams e WHERE e.exam_id = $examtype AND s.batch = $batch AND s.group = $group;";
//   echo $queryString;
...
<div class="col-md-9 bg-light">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <option value="1">First Year Mid</option>
                <option value="2">First Year Final</option>
                <option value="3">Pretest 13 Subjects</option>
                <option value="4">Second Year Test 13 Subjects</option>
                <option value="5">Final Model Test 13 Subjects</option>
